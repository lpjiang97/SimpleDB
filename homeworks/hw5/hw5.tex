...
\begin{enumerate}[label=\textbf{\arabic*.}, listparindent=0.0em, itemsep=1em]
  \item See table \par
    \begin{tabularx}{\linewidth}{Y|Y|Y|Y|Y}
      ...
      RSW & 100100 + 2K + 2K * 10  = 122,100 & 1K records on 300 pages & Nested loop join of RS (outer) W & P \\ \hline
      \tikzmark{StartC}WRS & 1010 + 20 + 20 * 1K = 21030 & 1K records on 300 pages & Nested loop join of WR (outer) S & K \tikzmark{EndC} \\ \hline
		\end{tabularx}
